        ...
        <Pagelayout title="Privacy Policy">
            ...
            <div className="content px-5 my-5">
                <p>
                    ...
                    visit our site and how we use cookies on this website. We do
                    update this policy from time to time so please do review
                    this policy regularly.
                </p>
                <p>
                    {" "}
                    Jenjen Luxury wigs are committed to preserving the privacy
                    of our visitors. Any information provided will be regulated
                    In accordance with the Data Protection Act 1998.{" "}
                </p>
                <p>
                    {" "}
                    We will not disclose any personal information to any other
                    party without consent and will only use your information for
                    the purposes of transactions made through our website and
                    fraud prevention.
                </p>
                <p>
                    {" "}
